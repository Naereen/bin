...
class NautilusTerminal(object):
    ...
    def _on_term_child_exited(self, term):
        ...
        """
        print "_on_term_child_exited have been called (shell is terminated)"
...
class NautilusTerminalProvider(GObject.GObject, Nautilus.LocationWidgetProvider):
    ...
    def __init__(self):
        """The constructor."""
        print("[%s] I: Initializing the Nautilus extension. (c) 2013 %s"
                % (__app_disp_name__, __author__))
